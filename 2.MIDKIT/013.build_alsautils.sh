...
export MODNAME=alsautils

export MODPKG_NAME=alsa-utils-1.0.23.tar.gz
export MODSRC_NAME=alsa-utils-1.0.23
...
{
	cd ${MODSRC_PATH}
    ./configure  --host=${HOST} --prefix=${MODOUT_PATH} --disable-xmlto --disable-alsamixer
	make && make install
